  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{sureAddressInfo.fullAddress}}</span>
        收货人：<span>{{sureAddressInfo.consignee}}</span>
        <span>{{sureAddressInfo.phoneNum}}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async submitOrder () {
      ...
      let data = {
        consignee: this.sureAddressInfo.consignee,
        consigneeTel: this.sureAddressInfo.phoneNum,
        deliveryAddress: this.sureAddressInfo.fullAddress,
        paymentWay: "ONLINE",
